  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="relative rounded-full p-2 text-slate-400 hover:text-white focus:outline-none transition-colors"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-96 bg-white dark:bg-slate-800 rounded-lg shadow-xl border border-gray-200 dark:border-slate-700 z-50 max-h-[600px] overflow-hidden flex flex-col">
          {/* Header */}
          <div className="px-4 py-3 border-b border-gray-200 dark:border-slate-700 flex justify-between items-center">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Notificări</h3>
            {unreadCount > 0 && (
              <button
